...
public class WalkTest extends TestCase {
	...
	/*
	 * Test method for 'de.berlios.svgcompost.animation.anim.chara.Walk.skewXbyYscaleY(Float, Float, Float)'
	 */
...
//		assertTrue( trafo2.equals( trafo ) );
	...
	/*
	 * Test method for 'de.berlios.svgcompost.animation.anim.chara.Walk.skewYbyXscaleX(Float, Float, Float)'
	 */
