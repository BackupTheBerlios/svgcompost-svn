...
public class PathConverter {
	...
	public static ExtendedGeneralPath convertedPath;

	public static ExtendedGeneralPath convertPath(ExtendedGeneralPath path) {
...
//		swfMoveRecord( current, start[X], start[Y] );
	...
	public static void convertEdge( int type, float[] current, float[] points ) {
		switch (type) {
	...
	public static void swfMoveRecord( float[] current, float[] points ) {
		swfMoveRecord( current, points[0], points[1] );
	}
	
	public static void swfMoveRecord( float[] current, float x, float y ) {
		convertedPath.moveTo( x, y );
		current[X] = x;
		current[Y] = y;
	}
	
	public static void swfLineRecord( float[] current, float[] points ) {
		swfLineRecord( current, points[0], points[1] );
	}
	
	public static void swfLineRecord( float[] current, float x, float y ) {
		convertedPath.lineTo( x, y );
		current[X] = x;
		current[Y] = y;
	}
	
	public static void swfQuadRecord( float[] current, float[] points ) {
		swfQuadRecord( current, points[0], points[1], points[2], points[3] );
	}
	
	public static void swfQuadRecord( float[] current, float cx, float cy, float ax, float ay ) {
//		if(0==0) {
...
//			return;
	...
	public static void splitCubicIntoQuads( float[] current, float[] points ) {
	...
	public static boolean isProblematic( float[] a1, float[] c1, float[] a2, float[] c2 ) {
	...
	public static int triangleOrientation(float[] p, float[] q, float[] r) {
	...
	public static float[] intersectionAbs( float[] a, float[] b, float[] c, float[] d ) {
		// x1 = a + n*(b-a)
		// x2 = c + m*(d-c)
		return intersection( a, new float[] {b[X]-a[X], b[Y]-a[Y]}, c, new float[] {d[X]-c[X], d[Y]-c[Y]} );
	}
	
	public static float[] intersection( float[] a, float[] b, float[] c, float[] d ) {
		// x1 = a + n*b
		// x2 = c + m*d
