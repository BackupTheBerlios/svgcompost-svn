...
import de.gerrit_karius.cutout.export.SwfmlShapeImport;

public class BinaryExport implements Export {
	
	private static Logger log = Logger.getLogger(BinaryExport.class);
	...
	public BinaryExport( Canvas canvas ) {
		this.canvas = canvas;
